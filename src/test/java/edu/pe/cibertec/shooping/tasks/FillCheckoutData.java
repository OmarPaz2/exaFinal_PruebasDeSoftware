...
public class FillCheckoutData implements Task {

    public static FillCheckoutData complete() {
        return new FillCheckoutData();
    }
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                ...
                Enter.theValue("Av. Principal 123").into(CheckoutScreen.ADDRESS_FIELD),
